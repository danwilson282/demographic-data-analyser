...
def calculate_demographic_data(print_data=True):
    ...
    per_rich = round(df.loc[df['salary']=='>50K', 'native-country'].value_counts()/df['native-country'].value_counts()*100,1)
    highest_earning_country = per_rich.idxmax()
    highest_earning_country_percentage = per_rich.max()
